    ...
    return (
        <div style={{...getScreenStyle(
            ...
            <div className='welcome-card-style'>
                <div className='login-header-style'>Forgot Username</div>
                ...
                <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
                    <p style={{ margin: 0, textAlign: 'center', opacity: 0.9 }}>
                        Enter your email and we will send your username.
                    </p>
                    ...
                    <button className='login-button' onClick={handleSubmit}>Email My Username</button>
